'''
https://www.codewars.com/kata/5a5c118380eba8a53d0000ce/train/python
...
def convert_my_dollars(usd, currency):
    letters = ['a', 'e', 'i', 'o', 'u', 'y']
    if currency[0].lower() in letters:
        return f"You now have {usd * CONVERSION_RATES.get(currency)} of {currency}."
    else:
        return f"You now have {usd * int(str(CONVERSION_RATES.get(currency)), 2)} of {currency}."


if __name__ == '__main__':
    print(convert_my_dollars(25, "Armenian Dram"))